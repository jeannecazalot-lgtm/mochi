...
// ─── Mochi : corps galet validé par Jeanne le 14 sept 2026 (visage et matière v1 conservés) ─
// Dessin dans mochi-v2.js (MochiGalet) ; version vivante dans motion.js (LiveMochi).
export function Mochi({ size = 140, mood = 'happy', lean = 0 }) {
  return <MochiGalet size={size} mood={mood} lean={lean} />;
}
