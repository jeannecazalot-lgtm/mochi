...
Décisions Jeanne 14 sept : Suivi = présentation C colorée, textes raccourcis ; « À venir » = 2 jours (page fixe) ; **Wrapped = « hyper important, on va bosser dessus »** → à brancher en réel avec Jeanne (session dédiée : contenu des stories solo / couple, calculs sur les vraies semaines, notif du dimanche). Bilan mensuel / mood / analyse : à trancher (couper ou garder).
