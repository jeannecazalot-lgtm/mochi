...
- **Point 2 livré** : la sheet Dépense écrit dans `expenses` (file de synchro + temps réel), photos des payeurs ; vérifié à deux : « Pizzas 24 € » chez Lea → « Tu dois 12,00 € à Lea » chez Kima. **Migration 0007 à appliquer par Jeanne** (éditeur SQL, copiée dans le presse-papiers) : catégories Maison/Enfants/Santé ajoutées à l'enum `expense_cat` — sans elle, ces trois catégories sont refusées (22P02) et jetées de la file.
