...
- **Build 10 lancé à la demande de Jeanne** (6 sept, ~11h15, `eas build --platform ios --profile production --auto-submit`) après bot couple (42 pas, 0 point fragile) et export JS OK. Embarque : sheet Tâche v2 (Jeanne), lots 1-3, dépense réelle, état « Déjà fait ». Le badge numéro d'écran et le bouton « Plan des écrans » restent (outils de retour de Jeanne, TestFlight).
